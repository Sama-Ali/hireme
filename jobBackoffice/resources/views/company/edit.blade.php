<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between">
            ...
            <a
                href="{{ request()->routeIs('my-company.*') ? route('my-company.show') : route('companies.show', $company) }}"
        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-teal-200/70">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ request()->routeIs('my-company.*') ? route('my-company.update') : route('companies.update', $company) }}" class="space-y-6">
                        @csrf
                        @method('PUT')
